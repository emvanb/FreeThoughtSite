  ...
  function GoogleUrl(sourceIdentifier) {
    ...
    if (this.sourceIdentifier.match(/https:/)) {
      this.url = this.sourceIdentifier;
       this.key = "1ydtfBCsLe-I84NWTNTWld2TFYmH7pgZ959v2EnAY2Pk";
      try {
    ...
    this.jsonCellsUrl = "https://spreadsheets.google.com/feeds/cells/1ydtfBCsLe-I84NWTNTWld2TFYmH7pgZ959v2EnAY2Pk/od6/public/basic?alt=json-in-script";
    this.jsonListUrl = "https://spreadsheets.google.com/feeds/list/1ydtfBCsLe-I84NWTNTWld2TFYmH7pgZ959v2EnAY2Pk/od6/public/basic?alt=json-in-script";
